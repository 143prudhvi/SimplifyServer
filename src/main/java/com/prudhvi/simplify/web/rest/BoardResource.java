...
/**
 * REST controller for managing {@link com.prudhvi.simplify.domain.Board}.
 */
@RestController
@RequestMapping("/api")
public class BoardResource {
    ...
    public ResponseEntity<Board> partialUpdateBoard(@PathVariable(value = "id", required = false) final Long id, @RequestBody Board board)
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, board.getId().toString())
        );
    }
