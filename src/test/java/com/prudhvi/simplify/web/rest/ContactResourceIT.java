...
import com.prudhvi.simplify.domain.Contact;
import com.prudhvi.simplify.repository.ContactRepository;
...
class ContactResourceIT {
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().name(DEFAULT_NAME).phone(DEFAULT_PHONE);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().name(UPDATED_NAME).phone(UPDATED_PHONE);
        return contact;
    }
    ...
    void putNewContact() throws Exception {
        ...
        updatedContact.name(UPDATED_NAME).phone(UPDATED_PHONE);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.name(UPDATED_NAME).phone(UPDATED_PHONE);
