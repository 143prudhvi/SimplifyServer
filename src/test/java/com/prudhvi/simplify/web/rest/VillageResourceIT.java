...
import com.prudhvi.simplify.repository.VillageRepository;
...
class VillageResourceIT {
    ...
    public static Village createEntity(EntityManager em) {
        Village village = new Village().board(DEFAULT_BOARD).village(DEFAULT_VILLAGE);
        return village;
    }
    ...
    public static Village createUpdatedEntity(EntityManager em) {
        Village village = new Village().board(UPDATED_BOARD).village(UPDATED_VILLAGE);
        return village;
    }
    ...
    void putNewVillage() throws Exception {
        ...
        updatedVillage.board(UPDATED_BOARD).village(UPDATED_VILLAGE);
    ...
    void partialUpdateVillageWithPatch() throws Exception {
        ...
        partialUpdatedVillage.board(UPDATED_BOARD);
    ...
    void fullUpdateVillageWithPatch() throws Exception {
        ...
        partialUpdatedVillage.board(UPDATED_BOARD).village(UPDATED_VILLAGE);
